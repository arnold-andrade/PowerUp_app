...
public final class ItemBinding implements ViewBinding {
  ...
  private ItemBinding(@NonNull CardView rootView, @NonNull TextView tvEndDate,
      @NonNull TextView tvName, @NonNull TextView tvStartDate) {
  ...
  public static ItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBinding((CardView) rootView, tvEndDate, tvName, tvStartDate);
    }
