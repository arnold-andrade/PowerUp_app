...
public final class ActivityApplyleaveBinding implements ViewBinding {
  ...
  private ActivityApplyleaveBinding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
  ...
  public static ActivityApplyleaveBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_applyleave, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityApplyleaveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityApplyleaveBinding((ConstraintLayout) rootView, button2, editTextText2,
          editTextText3, editTextText4, textView2, textView4);
    }
