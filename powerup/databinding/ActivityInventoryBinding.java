...
public final class ActivityInventoryBinding implements ViewBinding {
  ...
  private ActivityInventoryBinding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
      @NonNull Button button3, @NonNull EditText editTextText2, @NonNull EditText editTextText3,
      @NonNull EditText editTextText4, @NonNull TextView textView2, @NonNull TextView textView4) {
  ...
  public static ActivityInventoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityInventoryBinding((ConstraintLayout) rootView, button2, button3,
          editTextText2, editTextText3, editTextText4, textView2, textView4);
    }
